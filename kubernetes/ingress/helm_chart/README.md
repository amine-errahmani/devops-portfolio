...
else it would make it impossible to evacteste a node. See [gh issue #7127](https://github.com/helm/charts/issues/7127) for more info.
...
controller:
  service:
    targetPorts:
      ...
      https: http
    annotations:
      service.beta.kubernetes.io/aws-load-balancer-ssl-cert: arn:aws:app3:XX-XXXX-X:XXXXXXXXX:certificate/XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXX
